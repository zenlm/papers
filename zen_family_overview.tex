...
visual creation, design analysis, and speech recognition. Built on transformer architectures and optimized 
...
techniques including Mixture of Experts, extended thinking modes, and aggressive quantization, the Zen family broadens 
...
Our objective: provide AI capabilities through models that are:
\begin{itemize}
...
The Zen family targets the following efficiency profile:
...
The Zen AI Model Family extends prior MoE language modeling work, illustrating that capability and 
efficiency are not mutually exclusive. Through innovative architectures, training techniques, and deployment 
strategies, we have created a coordinated set of models that broaden access to frontier AI while 
...
\bibitem{brown2020language} T.~Brown et al., ``Language Models are Few-Shot Learners,'' \textit{NeurIPS}, 2020.
\bibitem{touvron2023llama} H.~Touvron et al., ``LLaMA: Open and Efficient Foundation Language Models,'' \textit{arXiv:2302.13971}, 2023.
\bibitem{hoffmann2022training} J.~Hoffmann et al., ``Training Compute-Optimal Large Language Models,'' \textit{arXiv:2203.15556}, 2022.
...
\bibitem{fedus2022switch} W.~Fedus, B.~Zoph, and N.~Shazeer, ``Switch Transformers: Scaling to Trillion Parameter Models,'' \textit{JMLR}, vol.~23, 2022.
