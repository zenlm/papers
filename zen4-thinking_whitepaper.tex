...
\bibitem{wang2022selfconsistency} Wang, X. et al. (2022). Self-Consistency Improves Chain of Thought Reasoning in Language Models. ICLR 2023.
\bibitem{lightman2023let} Lightman, H. et al. (2023). Let's Verify Step by Step. arXiv:2305.20050.
\bibitem{nye2021show} Nye, M. et al. (2021). Show Your Work: Scratchpads for Intermediate Computation with Language Models. arXiv:2112.00114.
\bibitem{snell2024scaling} Snell, C. et al. (2024). Scaling LLM Test-Time Compute Optimally Can Be More Effective Than Scaling Model Parameters. arXiv:2408.03314.
...
\bibitem{singhal2023long} Singhal, K. et al. (2023). A Long Way to Go: Investigating Length Correlations in RLHF. arXiv:2310.03716.
